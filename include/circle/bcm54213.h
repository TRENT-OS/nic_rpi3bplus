...
typedef struct TGEnetTxRing			// ring of Tx buffers
{
	...
	void		(*int_enable)(struct TGEnetTxRing *);
} TGEnetTxRing;

typedef struct TGEnetRxRing			// ring of Rx buffers
{
	...
	unsigned	old_discards;
 	void		(*int_enable)(struct TGEnetRxRing *);
} TGEnetRxRing;

/// Driver for BCM54213PE Gigabit Ethernet Transceiver
// public:
...
TSpinLock m_TxSpinLock;
// TSpinLock 	*const spinlock = &m_TxSpinLock;
